...
describe("animate", () => {
        ...
        animate({
            ...
            onComplete: () => {
                expect(numeric).toEqual([
                    0, 21, 68, 122, 170, 205, 225, 232, 231, 224, 215, 207, 200,
                    197, 195, 195, 196, 197, 199, 200, 200, 201, 201, 201, 201,
                    200,
                ])
    ...
    test("Correctly applies repeat type 'mirror'", async (resolve) => {
        testAnimate(
            ...
            [
                0, 35.999999999999986, 64, 84, 96, 100, 64.00000000000001, 36,
                16, 4, 0,
            ],
            resolve
        )
    ...
    test("Correctly applies repeatDelay", async (resolve) => {
        testAnimate(
            ...
            [
                0, 20, 40, 60, 80, 100, 100, 100, 100, 100, 100, 20, 40, 60, 80,
                100, 100, 100, 100, 100, 100, 20, 40, 60, 80, 100,
            ],
            resolve
        )
    })
    ...
    test("Correctly applies repeatDelay to reverse", async (resolve) => {
        testAnimate(
            ...
            [
                0, 20, 40, 60, 80, 100, 100, 100, 100, 100, 100, 80, 60, 40, 20,
                0, 0, 0, 0, 0, 0, 20, 40, 60, 80, 100,
            ],
            resolve
        )
    ...
    test("Correctly applies repeatDelay to mirror", async (resolve) => {
        testAnimate(
            ...
            [
                0, 35.999999999999986, 64, 84, 96, 100, 100, 100, 100, 100, 100,
                64.00000000000001, 36, 16, 4, 0, 0, 0, 0, 0, 0,
    ...
    test("Runs animations as an underdamped spring", async (resolve) => {
        const output: number[] = []
        const expected = [
            100, 371, 884, 1259, 1343, 1204, 1006, 883, 873, 937, 1011, 1050,
            1046, 1018, 991, 980, 984, 996, 1005, 1008, 1005, 1001, 998, 997,
            998, 1000, 1001, 1001, 1001, 1000, 1000,
        ]
        animate({
            from: 100,
            to: 1000,
    ...
    test("Repeats springs", async (resolve) => {
        ...
        const expected = [
            100, 371, 884, 1259, 1343, 1204, 1006, 883, 873, 937, 1011, 1050,
            1046, 1018, 991, 980, 984, 996, 1005, 1008, 1005, 1001, 998, 997,
            998, 1000, 1001, 1001, 1001, 1000, 1000, 371, 884, 1259, 1343, 1204,
            1006, 883, 873, 937, 1011, 1050, 1046, 1018, 991, 980, 984, 996,
            1005, 1008, 1005, 1001, 998, 997, 998, 1000, 1001, 1001, 1001, 1000,
            1000,
        ]
        animate({
            from: 100,
    ...
    test("Repeats springs with repeat delay", async (resolve) => {
        ...
        const expected = [
            100, 371, 884, 1259, 1343, 1204, 1006, 883, 873, 937, 1011, 1050,
            1046, 1018, 991, 980, 984, 996, 1005, 1008, 1005, 1001, 998, 997,
            998, 1000, 1001, 1001, 1001, 1000, 1000, 1000, 1000, 1000, 1000,
            1000, 1000, 371, 884, 1259, 1343, 1204, 1006, 883, 873, 937, 1011,
            1050, 1046, 1018, 991, 980, 984, 996, 1005, 1008, 1005, 1001, 998,
            997, 998, 1000, 1001, 1001, 1001, 1000, 1000, 1000, 1000, 1000,
            1000, 1000, 1000, 371, 884, 1259, 1343, 1204, 1006, 883, 873, 937,
            1011, 1050, 1046, 1018, 991, 980, 984, 996, 1005, 1008, 1005, 1001,
    ...
    test("Repeats springs as 'reverse'", async (resolve) => {
        ...
        const expected = [
            100, 371, 884, 1259, 1343, 1204, 1006, 883, 873, 937, 1011, 1050,
            1046, 1018, 991, 980, 984, 996, 1005, 1008, 1005, 1001, 998, 997,
            998, 1000, 1001, 1001, 1001, 1000, 1000, 1000, 1001, 1001, 1001,
            1000, 998, 997, 998, 1001, 1005, 1008, 1005, 996, 984, 980, 991,
            1018, 1046, 1050, 1011, 937, 873, 883, 1006, 1204, 1343, 1259, 884,
            371, 100,
        ]
        animate({
            from: 100,
    ...
    test("Repeats springs as 'reverse' with repeatDelay", async (resolve) => {
        const output: number[] = []
        const expected = [
            100, 884, 1343, 1006, 873, 1011, 1046, 991, 984, 1005, 1005, 998,
            998, 1001, 1001, 1000, 1000, 1000, 1000, 1001, 1001, 998, 998, 1005,
            1005, 984, 991, 1046, 1011, 873, 1006, 1343, 884, 100, 100, 100,
            100, 884, 1343, 1006, 873, 1011, 1046, 991, 984, 1005, 1005, 998,
            998, 1001, 1001, 1000,
        ]
        animate({
    ...
    test("Repeats springs as 'mirror'", async (resolve) => {
        ...
        const expected = [
            100, 371, 884, 1259, 1343, 1204, 1006, 883, 873, 937, 1011, 1050,
            1046, 1018, 991, 980, 984, 996, 1005, 1008, 1005, 1001, 998, 997,
            998, 1000, 1001, 1001, 1001, 1000, 1000, 729, 216, -159, -243, -104,
            94, 217, 227, 163, 89, 50, 54, 82, 109, 120, 116, 104, 95, 92, 95,
            99, 102, 103, 102, 100, 99, 99, 99, 100, 100,
        ]
        animate({
            from: 100,
            to: 1000,
    ...
    test("Repeats springs as 'mirror' with repeatDelay", async (resolve) => {
        ...
        const expected = [
            100, 884, 1343, 1006, 873, 1011, 1046, 991, 984, 1005, 1005, 998,
            998, 1001, 1001, 1000, 1000, 1000, 1000, 216, -243, 94, 227, 89, 54,
            109, 116, 95, 95, 102, 102, 99, 99, 100, 100, 100, 100, 884, 1343,
            1006, 873, 1011, 1046, 991, 984, 1005, 1005, 998, 998, 1001, 1001,
            1000,
        ]
        animate({
            from: 100,
